 ...
 */
public class ContactsOfContact implements Serializable{
	...
	private String fristNameFirst;  //各个名字的首字母
	private boolean isAddGroup; //对象是否添加到组
	private float Alpha = 1.0F; //图片的透明度
